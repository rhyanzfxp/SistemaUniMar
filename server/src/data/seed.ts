...
async function seed() {
  ...
  const { error: gamesError } = await supabase.from("games").upsert([
    ...
    },
    {
      ...
      description:
        "Aprenda sobre o delicado equilíbrio dos manguezais cearenses.",
      icon: "🌳",
      color: "#10B981",
      max_score: 1000,
      question_count: 1,
    ...
    },
    {
      ...
      description:
        "Ajude os filhotes de caranguejo a encontrar o caminho certo pelas raízes do manguezal dentro do tempo limite.",
      icon: "🦀",
      color: "#10B981",
      max_score: 4,
      question_count: 0,
